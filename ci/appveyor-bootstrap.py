...
URLS = {
    ("2.7", "64"): BASE_URL + "2.7.15/python-2.7.15.amd64.msi",
    ("2.7", "32"): BASE_URL + "2.7.15/python-2.7.15.msi",
...
def install_pip(home):
    ...
    if os.path.exists(pip_path):
        ...
        subprocess.check_call([python_path, GET_PIP_PATH])
...
if __name__ == "__main__":
    ...
    install_pip(os.environ['PYTHON_HOME'])
    install_packages(os.environ['PYTHON_HOME'], "setuptools>=18.0.1", "wheel", "tox", "virtualenv>=13.1.0")
